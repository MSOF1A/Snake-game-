document.addEventListener('DOMContentLoaded', () => {
    ...
    const startGame = () => {
        ...
        grid.style = (stopGame ? "background-color:wheat" : "background-color:hsla(268, 73%, 55%, 0.63")
    }
    ...
    grid.addEventListener('click', () => {
        if (!stopGame)
            ...
            interval = setInterval(moveOutcomes, intervalTime)
        grid.style = (stopGame ? "background-color:hsla(268, 73%, 55%, 0.63" : "background-color:wheat")
